...
var postDirPath = path_1.join(process.cwd(), "_posts");
var outputPostDirPath = path_1.join(process.cwd(), "out/posts");
var getPost = function (slug) { return __awaiter(void 0, void 0, void 0, function () {
    var fullPath, fileContents, data, post;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fullPath = path_1.join(postDirPath, slug + ".md");
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                promisePosts = slugs
                    ...
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.getPost(filename)];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                filePath = path_1.join(process.cwd(), "out/posts/rss.xml");
